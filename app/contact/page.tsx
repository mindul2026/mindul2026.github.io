...
//   title: '문의하기 | 주식회사 쉐릿',
//   description: '주식회사 쉐릿에 문의사항을 남겨주세요. 빠른 시일 내에 답변드리겠습니다.',
// }
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <svg className="h-6 w-6 text-primary-600 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-gray-900">업무시간</h3>
                    <p className="mt-1 text-gray-600">
                      평일: 09:00 - 18:00<br />
                      주말 및 공휴일 휴무
                    </p>
